    ...
    <div style="margin-top: 42px;" class="big ">
        <div class="row">
            ...
            <div class="baitap col-md-2 w3-theme mt-2">
                <h4 style="margin-left: 30px;">Bài Tập FORM</h4>
                <a class="dropdown-item" href="bt_form.php?bai=1">Bài 1</a><br>
                <a class="dropdown-item" href="bt_form.php?bai=2">Bài 2</a><br>
                <a class="dropdown-item" href="bt_form.php?bai=3">Bài 3</a><br>
                <a class="dropdown-item" href="bt_form.php?bai=4">Bài 4</a><br>
                <a class="dropdown-item" href="bt_form.php?bai=5">Bài 5</a><br>
                <a class="dropdown-item" href="bt_form.php?bai=6">Bài 6</a><br>
                <a class="dropdown-item" href="bt_form.php?bai=8">Bài 8</a><br>
                <a class="dropdown-item" href="bt_form.php?bai=9">Bài 9</a>
